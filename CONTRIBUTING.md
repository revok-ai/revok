...
1. **Fork** the repository and create a branch from `develop`:
   ...
   ```
     ...
     - Regular branches use prefixes: `feat/`, `fix/`, `test/`, `docs/`, `refactor/`.
         Example: `feat/crewai-pricing-demo`
     - Spec Kit implementation branches use sequential numbering auto-generated by Spec Kit.
         Examples: `001-create-spec-branch`, `002-zep-adapter`
     - Spec Kit branches are created automatically; do not rename them.
